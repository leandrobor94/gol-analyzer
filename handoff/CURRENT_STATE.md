...
| **Modelo 1X2** (`result.js`) | **AUC 0.870 / skill +42.6% fuera de muestra.** p≥0.70 → 92.3% (n=78, IC 84-96%). **El mejor resultado del proyecto.** No cableado; falta medir ventaja vs mercado en vivo |
